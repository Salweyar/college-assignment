...
INSERT INTO Customers  (CustNum, Company, CustRep, CreditLimit)
VALUES (2105, 'AAA Investments'    ,null, 450.00 ); 
...
INSERT INTO Salesreps (SalesRep, Name, Age, RepOffice, Title, HireDate, Manager, Quota, Sales)
VALUES (102, 'Sue Smith'      , 48, 21, 'Sales Rep' , '1986-12-29', 108, 3500.00, 4740.50 );
INSERT INTO Salesreps (SalesRep, Name, Age, RepOffice, Title, HireDate, Manager, Quota, Sales)
VALUES (106, 'Sam Clark'      , 52, 11, 'VP Sales'  , '1988-06-14', NULL, 2250.00, 2999.12 );
INSERT INTO Salesreps (SalesRep, Name, Age, RepOffice, Title, HireDate, Manager, Quota, Sales)
VALUES (104, 'Bob Smith'      , 33, 12, 'Sales Mgr' , '1987-05-19', 106, 2000.00, 1425.94 );
INSERT INTO Salesreps (SalesRep, Name, Age, RepOffice, Title, HireDate, Manager, Quota, Sales)
VALUES (101, 'Dan Roberts'    , 45, 12, 'Sales Rep' , '1986-10-20', 104, 1250.00, 3057.63 );
INSERT INTO Salesreps (SalesRep, Name, Age, RepOffice, Title, HireDate, Manager, Quota, Sales)
...
INSERT INTO Salesreps (SalesRep, Name, Age, RepOffice, Title, HireDate, Manager, Quota, Sales)
VALUES (107, 'Sally Angelli'  , 49, 22, 'Sales Rep' , '1988-11-14', 108, 3000.00, 1860.42 );
INSERT INTO Salesreps (SalesRep, Name, Age, RepOffice, Title, HireDate, Manager, Quota, Sales)
...
INSERT INTO Offices (Office, City, Region, Mgr, Target, Sales)
VALUES (21, 'Los Angeles'  , 'Western'  , 108, 7250.00, 9957.62 );
INSERT INTO Offices (Office, City, Region, Mgr, Target, Sales)
VALUES (30, 'Dallas'       , 'Southern' , 107, 9500.00,     .10 );
INSERT INTO Offices (Office, City, Region, Mgr, Target, Sales)
VALUES (43, 'Miami'        , 'Southern' , 107, 7500.00, 5123.22 );
...
INSERT INTO Orders (OrderNum, OrderDate, Cust, Rep, Mfr, Product, Qty, Amount)
VALUES (113196, '2005-01-21', NULL, 101, 'REI', '2A44R' ,500,  25.00 );
...
INSERT INTO Products (Mfr, Product, Description, Price, QtyOnHand)
VALUES ('RRC', 'L17',  'SQL*Plus/Users Guide', 13.95,  42 );
COMMIT;

--NAME: SALWEYAR PATEL
--STUDENT #: 0320109
--COURSE AND SECTION: DBMS-1000 (190592) Database Management Systems 1 AND 1
--DATE AND ASSIGNMENT#: 26-10-2019 AND 5

--Question 1
SELECT DECODE(City,'New York', 'N.Y.',
                   'Los Angeles', 'L.A.',
                    City) , Office
FROM Offices;

--Question 2
SELECT LOWER(CONCAT(SUBSTR(Name, INSTR(Name,1), 1),RTRIM(SUBSTR(Name, INSTR(Name,' ') + 1, 9)))) AS "UserName"
FROM SalesReps;
...
FROM SalesReps
WHERE ABS(MONTHS_BETWEEN(HireDate,'1988-05-01')) < 2;

--Question 4
SELECT Name, REPLACE(Title,'Sales Rep','Sales Representative') AS "Title", Trunc(Sales, -3) AS "Sales"
FROM SalesReps
WHERE Sales > 1000
ORDER BY Sales DESC;
...
--Question 5
SELECT Ordernum, NVL(TO_CHAR(Cust), '-1') AS "Customer Number" ,  TO_CHAR(OrderDate,'DAY Month DD, YYYY'), TO_CHAR(Amount,'$9999') AS "Amount"
FROM Orders
WHERE ROUND(Amount,-1) > 10;
